# Ejercicio 52 - Marcado de errores en Bases de Datos
# I. Crear un campo nuevo en la tabla de MySQL del ejercicio anterior llamado "Errores", de tipo texto, tamaño 10 
# caracteres.

# II. Partiendo de los datos obtenidos en el fichero errores.csv del ejercicio anterior, rellenar el contenido de 
# campo de la siguiente forma:

# Si el registro no tiene errores, escribir "NO"
# Si el registro tiene error en el NIF o NIE escribir "NIF" o "NIE", según proceda.
# Si el registro tiene error en el teléfono escribir "TELEFONO".
# Si el registro tiene varios errores (NIF/NIE y teléfono) escribir "VARIOS"
# Actualizar la base de datos al finalizar el programa y generar un documento copia.csv con todos los datos de la 
# tabla de MySQL una vez modificada.
