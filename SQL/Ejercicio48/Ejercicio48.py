# Ejercicio 48 - Cálculo de la letra de un NIE
# I. Realizar un programa que calcule el valor de la letra de un número de NIE.




# El algoritmo para calcular la letra del NIE es el siguiente:
...
# Como control de errores se deberá verificar además que el número introducido es un valor correcto, es decir, deberá tener 7 dígitos con números válidos, descartando letras. En caso de números con menos dígitos se deben escribir con ceros a la izquierda.

# Si lo introducido no es un número válido deberá indicarse con un mensaje y volver a preguntar.
...
# Sólo queda buscar el número completo junto a la letra obtenida en el paso anterior y ya tienes el NIE con su letra correspondiente.
